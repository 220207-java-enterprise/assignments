...
public class AboutEquality {
    ...
    static class Car {
        ...
        public boolean equals(Object other) {
            ...
            if (this == another && this != null){
                return true;
            }
            if (another == this && another != null){
                return true;
            }
            if (name == another.name && horsepower == another.horsepower){
                return true;
            }
            else {
                return false;
        ...
        public int hashCode() {
            ...
            int newhash = 0;
            newhash = name.hashCode() + horsepower;
            return newhash;
        }
    }
    ...
    static class Chicken {
        ...
        @Override
        public int hashCode() {
            return color.hashCode() + 4000; //modified to meet a unique value;
        }
    ...
    public void ownHashCodeImplementationPartTwo() {
        ...
        assertEquals(chicken1.hashCode() == chicken2.hashCode(), false); //see line 129.
