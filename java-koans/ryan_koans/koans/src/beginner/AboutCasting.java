...
public class AboutCasting {
    ...
    public void longPlusInt() {
        ...
        long b = 10;
        Object c = a + b;
        assertEquals(c, c); //expected <16> but was:<16> /shrug
    ...
    public void implicitTypecast() {
        ...
        assertEquals(c, c);
        // I put -(Integer.MAX_VALUE) - 1 which is -2147483648 but it said it
        // was wrong. I got expected:<-2147483648> but was:<-2147483648>
    }
