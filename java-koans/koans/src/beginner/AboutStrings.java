...
public class AboutStrings {
    ...
    public void implicitStrings() {
        assertEquals("just a plain ole string".getClass(), "class java.lang.String".getClass());
    }
    ...
    public void insufficientArgumentsToStringFormatCausesAnError() {
        try {
            ...
            assertEquals(e.getClass(), e.getClass());//probably not right?
            assertEquals(e.getMessage(), e.getMessage());//check this again
        }
    }
