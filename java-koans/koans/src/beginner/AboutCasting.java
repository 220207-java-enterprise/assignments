...
public class AboutCasting {
    ...
    public void upcastWithInheritance() {
        ...
        Parent parentReference = child; // Why isn't there an explicit cast? --> polymorphism
    ...
    public void classCasting() {
        try {
            ...
            ((Sleepable) o).sleep(); // would this even compile without the cast? --> YES o.sleep() would work
