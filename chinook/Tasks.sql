...
--
--
--Art Davidson@DESKTOP-BMQI0J2 MINGW64 ~/desktop/assignments/chinook (ArtDavidson)
--$ ls^C
--
--Art Davidson@DESKTOP-BMQI0J2 MINGW64 ~/desktop/assignments/chinook (ArtDavidson)
--$
...
--0c9133cd9655   postgres   "docker-entrypoint.s…"   28 hours ago   Up 28 hours   0.0.0.0:5432->5432/tcp   local-db
--
--Art Davidson@DESKTOP-BMQI0J2 MINGW64 ~/desktop/assignments/chinook (ArtDavidson)
--$ ls
--'Desktop - Shortcut.lnk'*   chinook-sql-workbook.md
--
--Art Davidson@DESKTOP-BMQI0J2 MINGW64 ~/desktop/assignments/chinook (ArtDavidson)
--$ cat chinook-sql-workbook.md
--# Revature Associate SQL Workbook
--
--## Part I – Working with an existing database
--
